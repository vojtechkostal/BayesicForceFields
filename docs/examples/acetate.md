...
- local reference config:
  [02-reference/config-local.yaml][acetate-reference]
- PLUMED prepare config:
  [01-prepare/plumed/config.yaml][acetate-prepare-plumed]
- local trainset config:
  [03-training-trjs/config-local.yaml][acetate-trainset]
- QoI config:
...
- `bff reference` consumes the staged CP2K reference inputs under
  ...
  outputs plus collected extxyz files under `02-reference/reference/system-XXX/`.
...
[acetate-reference]: https://github.com/vojtechkostal/BayesicForceFields/blob/main/examples/acetate/02-reference/config-local.yaml
...
[acetate-trainset]: https://github.com/vojtechkostal/BayesicForceFields/blob/main/examples/acetate/03-training-trjs/config-local.yaml
